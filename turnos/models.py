...
class Turno(models.Model):
    ...
    profesional = models.ForeignKey(Profesional, on_delete=models.CASCADE, default=1)
    fecha = models.DateField()
    hora = models.TimeField()

    def __str__(self):
        return f"{self.nombre} - {self.especialidad} - {self.profesional} - {self.fecha} {self.hora}"
